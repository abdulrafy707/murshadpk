                ...
                filteredData.map((item, index) => (
                  <tr key={item.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {item.imageUrl && <img src={`https://murshadpkdata.advanceaitool.com/uploads.php/${item.imageUrl}`} alt={item.name} className="w-16 h-16 object-cover" />}
                    </td>
          ...
          <div className="bg-white p-4 w-[700px] rounded shadow-lg">
            ...
            {newCategory.imageUrl && (
              <div className="mb-4">
                ...
                <img src={`https://murshadpkdata.advanceaitool.com/uploads.php/${newCategory.imageUrl}`} alt={newCategory.name} className="w-32 h-32 object-cover mb-2" />
              </div>
            )}
            <div className="mb-4">
